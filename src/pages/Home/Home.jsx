...
const Home = () => {
    ...
    useEffect(() => {
        ...
        dispatch(get_wear_categories({ level: 0, status: 'active' }));
    ...
    return (
        <div className="w-full pb-1 bg-gray-50/20 pt-[110px] md:pt-[130px] relative flex flex-col">
            <div>
                <HomeHeader 
                ...
                <CategoryRow 
                    ...
                    loading={catLoader} 
                    onCategoryClick={(cat) => navigate(`/products?category=${encodeURIComponent(cat.slug || cat.name)}&catId=${cat._id}`)}
                />
