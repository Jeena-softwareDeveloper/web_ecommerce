                        ...
                        {activeTab === 'inventory' && (
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
                                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50/30 rounded-xl p-4 border border-blue-100/80 shadow-xs">
                                        <div className="flex items-center justify-between mb-2">
                                            <p className="text-blue-900 text-[11px] font-bold">Total Products</p>
                                            <Package size={16} className="text-blue-600" />
                                        </div>
                                        <p className="text-blue-950 text-[18px] font-black">{stats.totalProducts || 0}</p>
                                    </div>
                                    <div className="bg-gradient-to-br from-rose-50 to-red-50/30 rounded-xl p-4 border border-rose-100/80 shadow-xs">
                                        <div className="flex items-center justify-between mb-2">
                                            <p className="text-rose-900 text-[11px] font-bold">Low Stock</p>
                                            <AlertCircle size={16} className="text-red-600" />
                                        </div>
                                        <p className="text-rose-955 text-[18px] font-black">{stats.lowStockItems || 0}</p>
                                    </div>
                                    <div className="bg-gradient-to-br from-emerald-50 to-green-50/30 rounded-xl p-4 border border-emerald-100/80 shadow-xs">
                                        <div className="flex items-center justify-between mb-2">
                                            <p className="text-emerald-900 text-[11px] font-bold">Total Value</p>
                                            <IndianRupee size={16} className="text-green-600" />
                                        </div>
                                        <p className="text-emerald-955 text-[18px] font-black">{formatCurrency(stats.totalValue || 0)}</p>
                                    </div>
                                    <div className="bg-gradient-to-br from-purple-50 to-fuchsia-50/30 rounded-xl p-4 border border-purple-100/80 shadow-xs">
                                        <div className="flex items-center justify-between mb-2">
                                            <p className="text-purple-900 text-[11px] font-bold">Locations</p>
                                            <MapPin size={16} className="text-purple-600" />
                                        </div>
                                        <p className="text-purple-955 text-[18px] font-black">{stats.locations || 0}</p>
                                    </div>
                                </div>

                                {/* QUICK ACTIONS */}
                                <div className="space-y-3">
                                    <h3 className="text-gray-900 text-sm font-bold">Quick Actions</h3>
                                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                                        <button 
                                            onClick={() => navigate('/supplier-stock/add')}
                                            className="bg-white border border-gray-100 p-4 rounded-xl flex flex-col items-center justify-center hover:bg-gray-50 shadow-sm hover:shadow transition-all active:scale-98"
                                        >
                            ...
                            <div className="space-y-4">
                                <div className="bg-white rounded-xl p-4 border border-gray-100">
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        <button 
                                            onClick={() => navigate('/supplier-stock/add')}
                                            className="bg-[#7C3AED] text-white px-3 py-2 rounded-lg text-xs font-bold flex items-center shadow-sm hover:bg-[#6D28D9] transition-all"
                                        >
