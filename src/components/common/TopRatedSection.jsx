...
const TopRatedSection = () => {
    ...
    return (
        <div className="py-2 bg-gray-50/50 border-y border-gray-100">
            {/* Section Header */}
            ...
            <div className="flex overflow-x-auto no-scrollbar px-3 space-x-3 md:space-x-5 pb-6 -mb-4 items-stretch">
                {products.slice(0, 4).map((product) => (
                    <div key={product._id} className="w-[170px] md:w-[220px] lg:w-[240px] flex-shrink-0">
