...
const RecentlyViewedSection = () => {
    ...
    return (
        <div className="py-5 bg-gradient-to-r from-blue-100/60 via-indigo-50/40 to-transparent border-y border-blue-100/20 mt-2">
            ...
            <div className="flex overflow-x-auto no-scrollbar px-3 space-x-2 md:space-x-5 pb-2 -mb-2 items-stretch snap-x snap-mandatory">
                {recentProducts.slice(0, 10).map((product) => (
                    <div key={product._id} className="w-[calc(50%-4px)] md:w-[200px] flex-shrink-0 snap-start">
                        <ProductCard product={{
                            ...product,
