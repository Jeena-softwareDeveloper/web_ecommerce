...
const RecentlyViewedSection = () => {
    ...
    return (
        <div className="py-5 bg-gradient-to-r from-blue-100/60 via-indigo-50/40 to-transparent border-y border-blue-100/20 mt-2">
            {/* Section Header */}
            ...
            <div className="flex overflow-x-auto no-scrollbar px-3 space-x-3 md:space-x-5 pb-6 -mb-4 items-stretch snap-x snap-mandatory">
                {recentProducts.slice(0, 10).map((product) => (
                    <div key={product._id} className="w-[calc(50%-6px)] md:w-[220px] lg:w-[240px] flex-shrink-0 snap-start">
                        <ProductCard product={{
                            ...product,
                            ...
                            colorName: product.colorName || product.variants?.[0]?.colorName
                        }} />
                    </div>
                ))}
            </div>
