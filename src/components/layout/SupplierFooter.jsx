...
const SupplierFooter = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-gray-100 flex items-center justify-around px-2 z-50 max-w-md mx-auto border-x shadow-[0_-1px_10px_rgba(0,0,0,0.02)] md:hidden lg:hidden">
            {tabs.map((tab) => {
