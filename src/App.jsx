...
const SupplierStock = lazy(() => import('./pages/SupplierStock/SupplierStock'));
const AddSupplierStock = lazy(() => import('./pages/SupplierStock/AddSupplierStock'));
const SupplierStockDetail = lazy(() => import('./pages/SupplierStock/SupplierStockDetail'));
const SupplierStockEdit = lazy(() => import('./pages/SupplierStock/SupplierStockEdit'));
      ...
      <ErrorBoundary>
        ...
        <Route path="/" element={<MainLayout />}>
          ...
          <Route element={<UserRoutes />}>
            ...
            <Route path="supplier-stock/add" element={<AddSupplierStock />} />
            <Route path="supplier-stock/:id" element={<SupplierStockDetail />} />
            <Route path="supplier-stock/edit/:id" element={<SupplierStockEdit />} />
            <Route path="become-supplier" element={<SupplierRegistration />} />
            <Route path="orders" element={<Orders />} />

            {/* Redirect / Fallback routes for slash URLs */}
            <Route path="supplier/dashboard" element={<Navigate to="/supplier-dashboard" replace />} />
            <Route path="supplier/inventory" element={<Navigate to="/supplier-inventory" replace />} />
            <Route path="supplier/orders" element={<Navigate to="/supplier-orders" replace />} />
            <Route path="supplier/payments" element={<Navigate to="/supplier-payments" replace />} />
            <Route path="supplier/pricing" element={<Navigate to="/supplier-pricing" replace />} />
            <Route path="supplier/warehouse" element={<Navigate to="/supplier-warehouse" replace />} />
            <Route path="supplier/promotions" element={<Navigate to="/supplier-promotions" replace />} />
          </Route>
